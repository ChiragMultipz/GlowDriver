...
import com.glow.driver.ui.profile.ResultNew
...
import com.glow.driver.databinding.ActivityCodeVerifyBinding
import com.glow.driver.extension.hideKeyboard
import com.glow.driver.extension.snackBar
...
class CodeVerifyActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun loginUser() {
        viewModel.viewModelScope.launch {
            viewModel.login(mobileNumber.toString(), Prefrences.getPreferences(ToastUtil.context, Constants.SELECTED_COUNTRY_CODE)!!)
        }
    }
